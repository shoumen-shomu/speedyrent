            ...
            <div className="mb-7.5">
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1" className={""}>
                  ...
                  >
                    Make sure to provide clear and detailed information about
                    the types of vehicles you offer, rental rates, rental
                    periods, and any additional fees or requirements.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
              ...
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1" className={""}>
                  <div className="flex gap-7.5 items-center">
                    ...
                    <div className="w-full">
                      <AccordionTrigger>Roadside Assistance</AccordionTrigger>
                    </div>
                  </div>
                  <AccordionContent
                    className={
